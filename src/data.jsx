...
export const faqs = [
  ...
  },
  {
    ...
    a: "He builds at the intersection of AI and the physical world: NLP pipelines and LLM-powered tools, machine-learning models, IoT and embedded systems on microcontrollers like the ESP32, Flutter and React Native mobile apps, and production client websites. Highlights include FIR-AI, an AI investigation assistant for Kerala Police; ThengaPari, a four-app Flutter marketplace; and a real-time GPS/IMU accident-detection safety app.",
  },
  {
